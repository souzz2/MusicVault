...
exports.getMusics = exports.searchMusicByName = exports.findMusicById = void 0;
const connection_1 = __importDefault(require("../connection"));
const findMusicById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, connection_1.default)("musics").where("idmusic", "=", id).orderBy("idmusic", "asc").limit(10);
});
exports.findMusicById = findMusicById;
const searchMusicByName = (name) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, connection_1.default)("musics").select("namemusic").where("namemusic", "like", `%${name}%`).orderBy("namemusic", "asc").limit(5);
});
